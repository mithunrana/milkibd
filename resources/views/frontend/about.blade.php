...
@section('main-content-section')
            ...
            <div class="row align-items-center clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div id="content_block_3">
                        <div class="content-box">
                            ...
                            <figure class="signature"><img src="{{asset('')}}frontend/assets/images/icons/signature-1.png" alt=""></figure>
                            <div class="btn-box">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_1">
                        <div class="image-box">
                            <div class="bg-layer" style="background-image: url({{asset('')}}frontend/assets/images/shape/bg-layer-1.png);"></div>
                            <figure class="image image-1"><img src="{{asset('')}}frontend/assets/images/resource/story-2.jpg" alt=""></figure>
    ...
    <!-- ourhistory-section -->
    <section class="ourhistory-section sec-pad" style="background-image: url({{asset('')}}frontend/assets/images/background/history-1.jpg);">
        <div class="auto-container">
            <div class="sec-title centred">
                <p>Our History</p>
                <h2>Learn More About <br />milki</h2>
            </div>
            <div class="inner-content">
                ...
                <div class="row clearfix">
                    <div class="col-lg-5 col-md-12 col-sm-12 inner-column">
                        <div class="inner-box">
                            <figure class="image-box mb-130"><img src="{{asset('')}}frontend/assets/images/resource/history-1.jpg" alt=""></figure>
                            ...
                            <figure class="image-box mb-130"><img src="{{asset('')}}frontend/assets/images/resource/history-2.jpg" alt=""></figure>
                            <div class="content-box">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 offset-lg-2 inner-column">
                        <div class="inner-box">
                            <div class="content-box mb-130">
                                ...
                                <h3>milki first lit the hearth in <br />February of 1990</h3>
                                <p>Excepteur sint occaecat cupidat proident sunt culpa officia deseru mollit anim est laborum magni dolore eos  ratione voluptam sequi nesciunt porro quisquam.</p>
                            </div>
                            <figure class="image-box mb-130"><img src="{{asset('')}}frontend/assets/images/resource/history-3.jpg" alt=""></figure>
                            <div class="content-box mb-130">
                                <span class="year">2010</span>
                                <h3>Our Morning Shift Started <br />in 2010</h3>
                                <p>Excepteur sint occaecat cupidat proident sunt culpa officia deseru mollit anim est laborum magni dolore eos  ratione voluptam sequi nesciunt porro quisquam.</p>
                            </div>
                            <figure class="image-box"><img src="{{asset('')}}frontend/assets/images/resource/history-4.jpg" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="auto-container">
            <div class="auto-container">
                <div class="clients-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                    <figure class="clients-logo-box"><a href="index.html"><img src="{{asset('')}}frontend/assets/images/clients/clients-logo-1.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index.html"><img src="{{asset('')}}frontend/assets/images/clients/clients-logo-2.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index.html"><img src="{{asset('')}}frontend/assets/images/clients/clients-logo-3.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index.html"><img src="{{asset('')}}frontend/assets/images/clients/clients-logo-4.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index.html"><img src="{{asset('')}}frontend/assets/images/clients/clients-logo-5.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index.html"><img src="{{asset('')}}frontend/assets/images/clients/clients-logo-6.png" alt=""></a></figure>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="testimonial-section sec-pad" style="background-image: url({{asset('')}}frontend/assets/images/background/testimonial-1.jpg);">
        ...
        <div class="auto-container">
            <div class="inner-box">
                <div class="sec-title">
                    <p>Testimonials</p>
                    <h2>What Clients Say About milki.</h2>
                </div>
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="pattern-layer" style="background-image: url({{asset('')}}frontend/assets/images/shape/shape-19.png);"></div>
